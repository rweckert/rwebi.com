// rwebiApp-ResultPanel-c61.js Created:12/22/2021 Updated:02/07/2026
// rwebi.com | rwebi.org | rwebi.net | 2026 Calyptus-61

// Panel Start: ------------------------
function pStart(){
document.getElementById('cp').textContent="p1";
PanelFull(1);PanelSelect('1');
const urlParams=new URLSearchParams(window.location.search);
const receivedValue=urlParams.get('data');
if (urlParams.has('data')){
if (receivedValue) {document.getElementById('qs').value=receivedValue;}
...
SearchValid();PanelFull(1);PanelSelect('1');}}
...
document.getElementById('cp').textContent="p2";
...
let phpUrl=`../_php/rwebiApp-ResultPanel-c61.php?qs=${encodeURIComponent(gqs)}`;
if (gcp==='p1') {
