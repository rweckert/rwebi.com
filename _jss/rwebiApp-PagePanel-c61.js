// rwebiApp-PagePanel-c61.js Created:12/22/2021 Updated:02/15/2026
...
PanelFull(2);PanelSelect('2');
LoadFrame('p1','../Modules/rwebiMenu-Modules.html');
...
var up=unescape(receivedValue);
LoadFrame('p2',up);} else {
var up="../Modules/rwebiMenu-Modules-Listing.html";
LoadFrame('p2',up);}}
