<?php
//                 _   _  
//   ___ _ _ _ ___| |_|_| Script: rwebiForm-ReportIssue.php
...
('$mmn', 'Issue Report', '$mme', '$mms', '$mmt', '$mmd')";
...
echo "<!-- Module Header: -->";
echo "<div id='mHeader' class='sh0' style='width:97vw;min-width:320px;'><span onclick='mReset();' title='Reload Module'><img src='../_ico/favicon.png' class='ibtn'></span>&nbsp;<div class='mTitle'>Report</div></div>";

echo "<!-- Content Container / Content View: -->";
echo "<div id='cc' class='sh9 em13' style='width:93vw;min-width:320px;'><p>Thank you for reporting this ssue to rwebi!</p><p>We truly appreciate you taking the time to connect with us during our beta phase. User contributions and comments regarding issues or bus are the heartbeat of our development process. Your feedback helps us identify what’s working and what we can do better to serve you.</p><p>I will be in touch shortly! - <span class='em11 bc'><a href='mailto:rweckert@gmail.com'>Robert W. Eckert</a></span></p>";
