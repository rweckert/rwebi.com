<?php
//                 _   _  
//   ___ _ _ _ ___| |_|_| Script: rwebiApp-ResultPanel.php
...
echo "</head><body>";
echo "<!--            _   _  ";
echo "  ___ _ _ _ ___| |_|_| Aplha Preview: rwebiApp-ResultPanel-c61.html";
...
<img src='https://www.google.com/s2/favicons?domain=$row[urlAddress]' width='28px' height='28px' style='padding:2px;margin-right:3px;'></td><td><a href='".$row["urlAddress"]."'><b>".$row["urlName"]."</b></a><br><span class='em8' id='l" . $row["urlRID"] . "' name='l" . $row["urlRID"] . "'><a href='" . $row["urlAddress"] . "' class='lbl em11' target='_parent'>" . $row["urlAddress"] . "</a></span></td><td style='width: 40px; text-align: center; vertical-align: middle;'><select id='" . $row["urlRID"] . "' name='" . $row["urlRID"] . "' class='wopt' onchange=\"ResultOpt('" . $row["urlRID"] . "')\" title='Result Options' style='width:18px;height:30px;padding-left:2px;'>
